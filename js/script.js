$(document).ready(function(){
    $('.btn').click(function(){
        ...
        if(browser===('Microsoft Internet Explorer')){
            if(tokens[0]>=11){
                json['Requeriments']="bate com os requerimentos";
            }    
            ...
            if(len(tokens)==3){
                if(tokens[0]>=9 && tokens[1]>=1 && tokens[2]>=2){
                    ...
                    json['Requeriments']="Não bate com os requerimentos";
                }
            }    
            ...
            if(tokens[0]>=47){
                json['Requeriments']="pass";
            }    
        }

        console.log(json);
        
        document.getElementById('requerimentos').innerHTML = JSON.stringify(json, undefined, 2);
